...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://open-ownership-frontend.vercel.app", "https://open-ownership-frontend-git-main-kondwani0099s-projects.vercel.app", "http://localhost:5173", "http://localhost:5174", "http://localhost:3000"],
